  ...
  const highlights = [
    {
      ...
      description: "Expert in creating automation frameworks using Python, Selenium, Robot Framework, and Pytest"
    },
    {
      icon: <Brain className="w-8 h-8" />,
      title: "ML Model Testing",
      description: "Specialized in testing Machine Learning algorithms including NLP, Audio Analytics, and Classification models"
    },
    {
      icon: <Database className="w-8 h-8" />,
      title: "API & Database Testing",
      description: "Comprehensive experience in API testing, database validation, and microservices testing"
    },
    {
      icon: <TestTube className="w-8 h-8" />,
      title: "Quality Assurance",
      description: "12 years of experience in various testing levels including Smoke, Integration, and Regression testing"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-slate-50 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            I'm passionate about leveraging cutting-edge testing methodologies and automation tools 
            to ensure software quality and reliability. My approach combines technical expertise with 
            a deep understanding of business requirements to deliver comprehensive testing solutions.
          </p>
        </div>
      </div>
    </section>
